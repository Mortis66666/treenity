...
$event = null;
if ($event_id > 0) {
    $event_result = $conn->execute_query("SELECT * FROM events WHERE event_id = ? AND organizer_id = ?", [$event_id, $organizer_id]);
...
$my_events_result = $conn->execute_query("SELECT event_id, name FROM events WHERE organizer_id = ? ORDER BY start_time DESC", [$organizer_id]);
$my_events = $my_events_result->fetch_all(MYSQLI_ASSOC);
        ...
        <div class="section-box">
            ...
            <table class="data-table">
                ...
                <tr>
                    ...
                    <td>
                        <a href="eo_participants_list.php?participant_id=<?php echo $p['participant_id']; ?>&event_id=<?php echo $event_id; ?>">View Detail</a>
                    </td>
                </tr>
                <?php $i++; } ?>

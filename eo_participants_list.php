    ...
    <main class="content">
            ...
            >
                ...
                <?php foreach ($my_events as $ev) { ?>
                    ...
                    <option
                        ...
                        <?php if ($event_id == $ev['event_id']) echo 'selected'; ?>
                    >
        ...
        <?php } else { ?>
            ...
            <div class="section-box">
                ...
                <form
                    method="GET"
                    action="eo_participants_list.php"
                    class="search-form"
                >
                    ...
                    <input
                        type="text"
                        name="search"
                        placeholder="Search by name or TP number..."
                ...
                <?php } else { ?>
                    ...
                    <table class="data-table">
                        ...
                        foreach ($participants as $p) {
                            ...
                            $points = isset(
                                $points_by_participant[$p['participant_id']]
                            )
                                ? $points_by_participant[$p['participant_id']]
                                : 0;
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo htmlspecialchars($p['tp_number']); ?>
                                </td>
                                ...
                                <td>
                                    ...
                                    <a
                                        href="eo_participants.php?participant_id=<?php echo $p['participant_id']; ?>&event_id=<?php echo $event_id; ?>"
                                    >
                                        View Detail
                                    </a>

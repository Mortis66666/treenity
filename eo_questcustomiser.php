...
<body>
    ...
    <main class="content">
        ...
        <form method="GET" action="EOQuestCustomizer.php" class="event-select-form">
        ...
        <div class="quest-layout">
            ...
            <div class="section-box">
                ...
                <form method="POST" action="EOQuestCustomizer.php">
            ...
            <div class="section-box">
                ...
                <?php } else { ?>
                    ...
                    <div class="quest-item">
                        ...
                        <form method="POST" action="EOQuestCustomizer.php" onsubmit="return confirm('Delete this quest?');">
